...
from nnunetv2.network.modules import StackedConvBlocks, StackedDMRCBlocks, StackedDMSCBlocks, StackedDMCBlocks
...
class Encoder(nn.Module):
    def __init__(self, input_channels, n_stages, features_per_stage):
        ...
        for s in range(n_stages):
            stage_modules = []
            if s != 0:
                stage_modules.append(nn.MaxPool2d(kernel_size=2, stride=2))
...
if __name__ == '__main__':
    ...
    model = Encoder(32, 6, (32, 64, 128, 256, 512, 512), nn.Conv2d, (1, 2, 2, 2, 2, 2), (2, 2, 2, 2, 2, 2), True)
